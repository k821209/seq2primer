...
file_seq = sys.argv[1] # fasta
file_name = sys.argv[2] # names 
Outfile  = file_name+'.primers.txt'

dicFa = kang.Fasta2dic(file_seq)
namelist = [x.strip() for x in open(file_name).readlines()]
...
with open(Outfile,'w') as f:
    for key in namelist:
        ...
        print (key,len(seq),primerF,TmF,genename,len(seq),primerR,TmR,seq,sep='\t',file=f)
